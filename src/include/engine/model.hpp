...
void model_draw(struct model *model, struct resource_gpu *program, bgfx_view_id_t view, uint64_t state, glm::mat4 mtx, bool frustumcull, struct camera *camera, bool prepass, struct envmap *env);
